    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="mb-8">
            <label className="block text-gray-700 text-lg mb-3">How did you hear about us?</label>
            <div className="relative">
              <button
                type="button"
                onClick={() => setShowDropdown(!showDropdown)}
                className="w-full px-6 py-3 text-xl border-2 border-[#005C3C] rounded-full focus:border-[#005C3C] focus:outline-none text-left flex items-center justify-between"
              >
                ...
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border-2 border-[#005C3C] rounded-lg shadow-lg z-10">
                  {hearAboutUsOptions.map((option) => (
                    <button
                      ...
                      className="w-full px-6 py-3 text-left hover:bg-gray-50 first:rounded-t-lg last:rounded-b-lg"
                    >
                      {option}
                    </button>
                  ))}
          ...
          <div className="text-center">
            <button
              ...
              className={`w-full px-12 py-3 rounded-full text-xl font-semibold transition-colors ${
