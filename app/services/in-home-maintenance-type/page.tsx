...
export default function InHomeMaintenanceTypePage() {
  ...
  const handleContinue = () => {
    if (selectedType) {
      ...
      window.location.href = `/services/in-home-maintenance-details?service=${service}&inHomeMaintenanceType=${selectedType}`
    }
  }
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-medium text-gray-900 mb-4" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
            What type of in-home maintenance service do you need?
          </h1>
        </div>
