...
export default function ExteriorMaintenanceTypePage() {
  ...
  const handleContinue = () => {
    if (selectedType) {
      ...
      window.location.href = `/find-job-sp/exterior-maintenance-details?service=${service}&exteriorMaintenanceType=${selectedType}`
    }
  }
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-medium text-gray-900 mb-4" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
            What type of exterior maintenance services do you provide?
          </h1>
        </div>
