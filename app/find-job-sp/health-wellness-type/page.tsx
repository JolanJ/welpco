...
export default function HealthWellnessTypePage() {
  ...
  const handleContinue = () => {
    if (selectedType) {
      ...
      window.location.href = `/find-job-sp/health-wellness-details?service=${service}&healthWellnessType=${selectedType}`
    }
  }
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-medium text-gray-900 mb-4" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
            What type of health & wellness services do you provide?
          </h1>
        </div>
