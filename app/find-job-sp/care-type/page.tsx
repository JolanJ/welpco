...
export default function CareTypePage() {
  ...
  const careTypes: CareType[] = [
    {
      id: "child-care",
      title: "Child Care",
      description: "Babysitting, child care, and supervision",
      icon: <Users className="w-8 h-8 text-[#005C3C]" />
    },
    {
      id: "elderly-care",
      title: "Elderly Care",
      description: "Senior care, companionship, and assistance",
    ...
    },
    {
      ...
      icon: <Brain className="w-8 h-8 text-[#005C3C]" />
    }
  ]
  ...
  const handleContinue = () => {
    if (selectedType) {
      // Navigate to the care details page with the selected care type
      window.location.href = `/find-job-sp/care-details?service=${service}&careType=${selectedType}`
    }
  }
